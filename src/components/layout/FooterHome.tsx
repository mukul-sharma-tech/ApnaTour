            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Jaipur, Rajasthan</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Goa</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Leh-Ladakh</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Uttrakhnad</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Kerala Backwaters</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Varanasi</a></li>
                            <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Andaman & Nicobar Islands</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-300">456 Wanderlust Avenue, Connaught Place, New Delhi, Delhi, India – 110001</span>
                            </li>
                            <li className="flex items-center">
                                <Phone size={20} className="mr-2 text-accent-400" />
                                <span className="text-gray-300">+91 92145 49810</span>
                            </li>
                            <li className="flex items-center">
